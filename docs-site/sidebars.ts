...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    {type: 'category', label: 'Guides', items: ['guides/install', 'guides/configuration', 'guides/executors-and-workspaces', 'guides/tools-and-sandbox', 'guides/contributing', 'contributing/testing']},
