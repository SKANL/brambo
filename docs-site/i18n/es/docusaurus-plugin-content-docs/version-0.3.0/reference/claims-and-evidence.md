...
audience: Developers, maintainers y reviewers que evalúan brambo
...
Esta página es la matriz de evidencia para las afirmaciones públicas de brambo. Separa una garantía ejecutable del repositorio de una intención de diseño documentada, un resultado medido pero acotado y un hecho administrativo o externo que este repositorio no puede probar por sí solo.
...
- **UNVERIFIED:** comportamiento, autenticación, rate limits o defaults de permisos de executors vendor fuera de los adapters y tests de contratos de brambo.
