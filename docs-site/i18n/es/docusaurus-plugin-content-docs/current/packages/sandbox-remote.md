...
`@brambo/sandbox-remote` adapta un transporte provisto por el caller al contrato `SandboxProvider` de brambo. Deliberadamente no define **ningún protocolo de red** ni abre conexiones por sí mismo.
