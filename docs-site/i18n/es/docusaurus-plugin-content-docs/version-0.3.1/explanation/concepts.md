...
`@brambodev/contracts` es el seam portable. Un provider puede usar archivos, SQLite u otra implementación y debe conservar el mismo contract y sus rechazos codificados.
