 ...
 *
 * ponytail: `@brambodev/registry` carries its own copy of this, because AD-2 forbids
 * the edge that would let it import this one and `@brambodev/contracts` must stay
