...
the types `@brambodev/contracts` exports; you should never have to read brambo's
source to write one.
...
```ts
import { activateMethod, validateMethodPlugin, type MethodPlugin } from '@brambodev/contracts'
```
