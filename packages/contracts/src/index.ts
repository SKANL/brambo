 ...
 * `@brambodev/cli` is FORBIDDEN to read files at all — eslint's thin-binding
 * pin. `@brambodev/environment` was tried next and its OWN guard test refused
 ...
 * `@brambodev/kernel`, which AD-1 forbids from importing this package at all.
 ...
 */
export const BRAMBO_VERSION = '0.3.0'
