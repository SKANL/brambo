...
import type { ResultEnvelope, RunRequest, WorkspaceHandle } from '@brambodev/contracts'
...
// factory and a disposer — the shape `@brambodev/registry`'s plugin established.
