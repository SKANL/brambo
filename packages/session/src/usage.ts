...
import { EXECUTOR_CATALOGUE } from '@brambo/adapter-cli'
import { USAGE_ABSENCE_REASONS, isUsageReport, usageAbsence } from '@brambo/contracts'
 ...
 * the way `@brambo/projection` writes ledgers, if concurrent runs become normal.
 */
