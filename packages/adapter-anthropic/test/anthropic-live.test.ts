...
const authorized = process.env.BRAMBO_RUN_LIVE_API_TESTS === '1' && !!process.env.ANTHROPIC_API_KEY && !!process.env.ANTHROPIC_MODEL &&
...
describe.skipIf(!authorized)('Anthropic live API (explicit opt-in and credential)', () => {
